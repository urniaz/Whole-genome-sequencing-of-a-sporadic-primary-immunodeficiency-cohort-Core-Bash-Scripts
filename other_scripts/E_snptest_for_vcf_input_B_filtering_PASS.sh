...
### Input VCF
IN=/scratch/data_20170104-B_update/chr6/gs10k_20170104-B_VCF_gnomad_exclude_less_0.01_MAF_exclude_less_0.05_no_indels_chr_6.vcf.gz

## Output file
OUT=/scratch/MHC_release_A_B/GEN/gs10k_20170104-B_VCF_gnomad_exclude_less_0.01_maf_ex_0.05_no_indels_chr_6_from_vcf_file_with_PASS.snptest

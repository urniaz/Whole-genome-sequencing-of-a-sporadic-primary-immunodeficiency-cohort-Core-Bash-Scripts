...
### Input VCF
IN=/scratch//WGS10K/data/release/20170104-B/merged-vcf/no_hgmd/chr"$CHR"_agg3_dedup_vep.vcf.gz

## Output file
OUT=/scratch/data_20170104-B/chr"$CHR"/gs10k_20170104-B_VCF_gnomad_exclude_less_0.01_chr_"$CHR".vcf.gz

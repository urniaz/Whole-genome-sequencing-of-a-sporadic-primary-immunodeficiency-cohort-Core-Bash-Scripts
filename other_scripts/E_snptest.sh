...
### Input VCF
IN=/scratch/MHC_release_A_B/GEN/gs10k_20170104-B_VCF_gnomad_exclude_less_0.01_maf_ex_0.05_no_indels_chr_"$CHR".gen.gen

## Output file
OUT=/scratch/MHC_release_A_B/GEN/gs10k_20170104-B_VCF_gnomad_exclude_less_0.01_maf_ex_0.05_no_indels_chr_"$CHR".snptest

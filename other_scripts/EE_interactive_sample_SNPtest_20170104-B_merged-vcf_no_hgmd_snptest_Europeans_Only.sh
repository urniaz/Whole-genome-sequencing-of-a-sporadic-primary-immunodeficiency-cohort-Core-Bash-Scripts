...
## Output file
OUT=/scratch/data_20170104-B/chr"$CHR"/SNPTEST_EUR_ONLY/SNP_test_res_gs10k_20170104-B_VCF_gnomad_exclude_less_0.01_MAF_filter_0.05_chr_"$CHR"_no_indels_EUR_only

## Sample file
SAMPLE=/scratch/data_20170104-B/snptest_sample_file_European_Only.sample
